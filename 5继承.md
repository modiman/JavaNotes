...
![类对象](C:\Users\modige\AppData\Roaming\Typora\typora-user-images\image-20211003111913690.png)
...
宏观地说，每个人都有姓名性别之类的属性，所以之前提到的父类Employee也可以有自己的父类Person,![image-20211003152218735](C:\Users\modige\AppData\Roaming\Typora\typora-user-images\image-20211003152218735.png)
...
在ArrayList<>的尖括号中不允许出现基本数据类型，就是说不允许写成ArrayList<int>，这时就需要Integer包装器
